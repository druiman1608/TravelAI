...
<form action="<?php echo e(route('flights.update', $flight->id)); ?>" method="POST">
    ...
    <input type="text" name="airline" value="<?php echo e(old('airline', $flight->airline)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <label>Origen:</label>
    <input type="text" name="origin" value="<?php echo e(old('origin', $flight->origin)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <input type="datetime-local" name="departure"
        value="<?php echo e(old('departure', $flight->departure->format('Y-m-d\TH:i'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <label>Llegada:</label>
    <input type="datetime-local" name="arrival" value="<?php echo e(old('arrival', $flight->arrival->format('Y-m-d\TH:i'))); ?>"
        required>
...
<br>
<a href="<?php echo e(route('flights.index')); ?>">Cancelar y volver</a><?php /**PATH /var/www/resources/views/flights/edit.blade.php ENDPATH**/ ?>